...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("Dialog", u"TODO", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("Dialog", u"Reminder", None))
